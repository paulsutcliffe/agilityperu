  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved contacto as @contacto" do
        ...
        post :create, {:contacto => { "titulo" => "invalid value" }}, valid_session
        expect(assigns(:contacto)).to be_a_new(Contacto)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested contacto" do
        ...
        expect_any_instance_of(Contacto).to receive(:update).with({ "titulo" => "MyString" })
        put :update, {:id => contacto.to_param, :contacto => { "titulo" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the contacto as @contacto" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Contacto.any_instance.stub(:save).and_return(false)
        put :update, {:id => contacto.to_param, :contacto => { "titulo" => "invalid value" }}, valid_session
        expect(assigns(:contacto)).to eq(contacto)
      end
