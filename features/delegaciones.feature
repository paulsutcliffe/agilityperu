...
#Característica: Administracion de las delegaciones en la web

#Esquema del escenario: Crear una delegacion
# Dado que estoy en la página inicial
# Cuando hago click en "Formulario"
